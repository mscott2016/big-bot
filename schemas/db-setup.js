...
const levels = require("./profile-schema.js");
var mongoUrl;
  ...
  */
  ...
  static async appendInviter(userId, guildId,inviter ) {
    if (!userId) throw new TypeError("An user id was not provided.");
    if (!guildId) throw new TypeError("A guild id was not provided.");
    if (!inviter) throw new TypeError("An amount of inviter was not provided.");
    ...
    user.save().catch(e => console.log(`Failed to append inviter: ${e}`) );

    return user;
  }


  static async appendInvitee(userId, guildId, invitee, invite ) {
    if (!userId) throw new TypeError("An user id was not provided.");
    if (!guildId) throw new TypeError("A guild id was not provided.");
    if (!invitee) throw new TypeError("An amount of invitee was not provided.");
  ...
  */
  ...
  static async setInvites(userId, guildId, invites) {
    if (!userId) throw new TypeError("An user id was not provided.");
    if (!guildId) throw new TypeError("A guild id was not provided.");
    if (!invites) throw new TypeError("A invites was not provided.");
    ...
    user.save().catch(e => console.log(`Failed to set invites: ${e}`) );
  ...
  */
  ...
  static async removeInvitee(userId, guildId, invitee,invites ) {
    if (!userId) throw new TypeError("An user id was not provided.");
    if (!guildId) throw new TypeError("A guild id was not provided.");
    if (!invitee) throw new TypeError("An amount of invitee was not provided.");
    ...
    const myIndex = user.invCount.indexOf(invitee);
    myIndex > -1 ? user.invCount.splice(myIndex, 1) : false;
    user.invites -= invites;
    user.lastUpdated = new Date();
