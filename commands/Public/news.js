...
class NewsCommand extends Command {
    ...
    async exec(message,args) {
        ...
        for (let i = 0; i < j; i++) {
            ...
            .setAuthor(`LOCAL CULTURE`,'https://media.socastsrm.com/wordpress/wp-content/blogs.dir/2165/files/2020/12/news-1.jpg',`https://twitter.com/localcultureart`)
